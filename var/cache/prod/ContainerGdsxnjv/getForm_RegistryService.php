...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ClubType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ClubType']) ? $this->services['AppBundle\Form\ClubType'] : $this->services['AppBundle\Form\ClubType'] = new \AppBundle\Form\ClubType()) && false ?: '_'};
}, 'AppBundle\\Form\\GameType' => function () {
...
}, 'AppBundle\\Form\\PlayerType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\PlayerType']) ? $this->services['AppBundle\Form\PlayerType'] : $this->services['AppBundle\Form\PlayerType'] = new \AppBundle\Form\PlayerType()) && false ?: '_'};
}, 'AppBundle\\Form\\RecoveryType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\RecoveryType']) ? $this->services['AppBundle\Form\RecoveryType'] : $this->services['AppBundle\Form\RecoveryType'] = new \AppBundle\Form\RecoveryType()) && false ?: '_'};
}, 'AppBundle\\Form\\RegisterType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\RegisterType']) ? $this->services['AppBundle\Form\RegisterType'] : $this->services['AppBundle\Form\RegisterType'] = new \AppBundle\Form\RegisterType()) && false ?: '_'};
...
}, 'EWZ\\Bundle\\RecaptchaBundle\\Form\\Type\\EWZRecaptchaType' => function () {
    return ${($_ = isset($this->services['ewz_recaptcha.form.type']) ? $this->services['ewz_recaptcha.form.type'] : $this->load('getEwzRecaptcha_Form_TypeService.php')) && false ?: '_'};
