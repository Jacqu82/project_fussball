 ...
 */
class AwayTeam extends \AppBundle\Entity\AwayTeam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AwayTeam' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AwayTeam' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\AwayTeam' . "\0" . 'games'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AwayTeam $proxy) {
