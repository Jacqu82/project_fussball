 ...
 */
class HomeTeam extends \AppBundle\Entity\HomeTeam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\HomeTeam' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\HomeTeam' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\HomeTeam' . "\0" . 'games'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomeTeam $proxy) {
