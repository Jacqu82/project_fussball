...
class Round extends \AppBundle\Entity\Round implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Round' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Round' . "\0" . 'games', '' . "\0" . 'AppBundle\\Entity\\Round' . "\0" . 'roundNumber', '' . "\0" . 'AppBundle\\Entity\\Round' . "\0" . 'season'];
        }
    ...
    public function setRoundNumber($roundNumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoundNumber', [$roundNumber]);

        return parent::setRoundNumber($roundNumber);
    }
    ...
    public function getRoundNumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoundNumber', []);

        return parent::getRoundNumber();
    }
